...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Nga - Trường Tiểu học Ngọc Đường  - ĐT: 0914205898</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Nga - Trường Tiểu học Ngọc Đường  - ĐT: 0914205898</div>", unsafe_allow_html=True)
